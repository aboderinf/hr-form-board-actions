    ...
    selections: [
      {
        ...
        odds: 171, book: 'draftkings', executionProbability: 0.3996, edge: 0.0306, ev: 0.0829,
      },
      {
        batterId: 545361, batterName: 'Mike Trout', matchup: 'CLE @ LAA',
        odds: 167, book: 'draftkings', executionProbability: 0.3988, edge: 0.0243, ev: 0.0649,
      },
      {
        batterId: 660688, batterName: 'Keibert Ruiz', matchup: 'COL @ WSH',
        odds: 145, book: 'betmgm', executionProbability: 0.4315, edge: 0.0234, ev: 0.0572,
      },
    ],
  },
});
  ...
  try {
    ...
    const output = {
      ...
      methodology: {
        ...
        forwardTracking: 'Each day’s top-three list is snapshotted immutably at the 8:17 AM execution checkpoint. MLB game logs later settle only those saved selections. No-appearance selections are void, and historical outcomes never promote a replacement player.',
      },
      split: {
