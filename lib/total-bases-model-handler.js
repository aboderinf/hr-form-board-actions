...
module.exports = async function totalBasesModelHandler(request, response) {
  ...
  try {
    ...
    const fixedHoldoutStart = '2026-08-17';
    ...
    const holdoutStart = settledDates.some((value) => value >= fixedHoldoutStart)
      ? fixedHoldoutStart
      : (splitIndex == null ? null : settledDates[splitIndex]);
    ...
    const output = {
      schemaVersion: 1,
      kind: 'batter_two_plus_total_bases_model_v1_3',
